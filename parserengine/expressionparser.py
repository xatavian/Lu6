...
from syntaxtree import AssignementExpression, AssignmentMultiplicationExpression, AssignmentAdditionExpression, \
                        ...
                        DivisionExpression, MultiplicationExpression, RemainderExpression, Variable
...
class ExpressionParser(Parser):
    ...
    def parse_primary_expression(self):
        ...
        raise ParserEngineException("No primary expression was found (token {})".format(self.current_token), self.parserhelper.current_line)
