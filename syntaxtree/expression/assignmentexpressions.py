...
from syntaxtree.expression.arithmeticexpressions import MultiplicationExpression, AdditionExpression,\
                                    DivisionExpression, RemainderExpression, \
                                    SubtractionExpression
from syntaxtree.expression.binaryexpression import BinaryExpression
from syntaxtree.general_interfaces import IGetValue, IValueHolder
from syntaxtree.variable import Variable
